...
public class NumbersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("four", "vier", R.drawable.number_four, R.raw.three));
        words.add(new Word("five", "fünf", R.drawable.number_five, R.raw.four));
        words.add(new Word("six", "sechs", R.drawable.number_six, R.raw.five));
        words.add(new Word("seven", "sieben", R.drawable.number_seven, R.raw.six));
